...
def change_model_type_txt2img_sd(model_txt2img_sd):
    if (model_txt2img_sd == "stabilityai/sdxl-turbo"):
        ...
        return sampler_txt2img_sd.update(value="Euler a"), width_txt2img_sd.update(value=biniou_global_sd15_width), height_txt2img_sd.update(value=biniou_global_sd15_height), num_inference_step_txt2img_sd.update(value=1), guidance_scale_txt2img_sd.update(value=0.0), lora_model_txt2img_sd.update(choices=list(lora_model_list(model_txt2img_sd).keys()), value="", interactive=False), txtinv_txt2img_sd.update(choices=list(txtinv_list(model_txt2img_sd).keys()), value=""), negative_prompt_txt2img_sd.update(interactive=False)
    elif (model_txt2img_sd == "SG161222/RealVisXL_V4.0_Lightning") or (model_txt2img_sd == "dataautogpt3/ProteusV0.4-Lightning"):
...
def change_model_type_img2img(model_img2img):
    if (model_img2img == "stabilityai/sdxl-turbo"):
        ...
        return sampler_img2img.update(value="Euler a"), width_img2img.update(), height_img2img.update(), num_inference_step_img2img.update(value=2), guidance_scale_img2img.update(value=0.0), lora_model_img2img.update(choices=list(lora_model_list(model_img2img).keys()), value="", interactive=False), txtinv_img2img.update(choices=list(txtinv_list(model_img2img).keys()), value=""), negative_prompt_img2img.update(interactive=False)
    elif (model_img2img == "SG161222/RealVisXL_V4.0_Lightning") or (model_img2img == "dataautogpt3/ProteusV0.4-Lightning"):
...
#        return sampler_img2img_ip.update(value="UniPC"), width_img2img_ip.update(value=biniou_global_sd15_width), height_img2img_ip.update(value=biniou_global_sd15_height), num_inference_step_img2img_ip.update(value=2), guidance_scale_img2img_ip.update(value=0.0), lora_model_img2img_ip.update(choices=list(lora_model_list(model_img2img_ip).keys()), value="", interactive=True), txtinv_img2img_ip.update(choices=list(txtinv_list(model_img2img_ip).keys()), value=""), negative_prompt_img2img_ip.update(interactive=False)
    ...
    elif (model_img2img_ip == "SG161222/RealVisXL_V4.0_Lightning") or (model_img2img_ip == "dataautogpt3/ProteusV0.4-Lightning"):
...
def change_model_type_controlnet(model_controlnet):
    ...
    elif (model_controlnet == "SG161222/RealVisXL_V4.0_Lightning") or (model_controlnet == "dataautogpt3/ProteusV0.4-Lightning"):
...
#        return sampler_faceid_ip.update(value="UniPC"), width_faceid_ip.update(), height_faceid_ip.update(), num_inference_step_faceid_ip.update(value=2), guidance_scale_faceid_ip.update(value=0.0), lora_model_faceid_ip.update(choices=list(lora_model_list(model_faceid_ip).keys()), value="", interactive=True), txtinv_faceid_ip.update(choices=list(txtinv_list(model_faceid_ip).keys()), value=""), negative_prompt_faceid_ip.update(interactive=False), prompt_faceid_ip.update()
    ...
    elif (model_faceid_ip == "SG161222/RealVisXL_V4.0_Lightning") or (model_faceid_ip == "dataautogpt3/ProteusV0.4-Lightning"):
...
def change_model_type_txt2vid_ze(model_txt2vid_ze):
    ...
    elif (model_txt2vid_ze == "SG161222/RealVisXL_V4.0_Lightning") or (model_txt2vid_ze == "dataautogpt3/ProteusV0.4-Lightning"):
                            ...
                            with gr.Column():
                                with gr.Box():
                                    with gr.Group():
                                        ...
                                        txt2img_sd_faceswap = gr.Button(f"🖼️ >> {biniou_lang_tab_faceswap} target")
                            ...
                            with gr.Column():
                                with gr.Box():
                                    with gr.Group():
                                        ...
                                        txt2img_kd_faceswap = gr.Button(f"🖼️ >> {biniou_lang_tab_faceswap} target")
                            ...
                            with gr.Column():
                                with gr.Box():
                                    with gr.Group():
                                        ...
                                        txt2img_lcm_faceswap = gr.Button(f"🖼️ >> {biniou_lang_tab_faceswap} target")
                            ...
                            with gr.Column():
                                with gr.Box():
                                    with gr.Group():
                                        ...
                                        txt2img_mjm_faceswap = gr.Button(f"🖼️ >> {biniou_lang_tab_faceswap} target")
                            ...
                            with gr.Column():
                                with gr.Box():
                                    with gr.Group():
                                        ...
                                        txt2img_paa_faceswap = gr.Button(f"🖼️ >> {biniou_lang_tab_faceswap} target")
                            ...
                            with gr.Column():
                                with gr.Box():
                                    with gr.Group():
                                        ...
                                        img2img_faceswap = gr.Button(f"🖼️ >> {biniou_lang_tab_faceswap} target")
                            ...
                            with gr.Column():
                                with gr.Box():
                                    with gr.Group():
                                        ...
                                        img2img_ip_faceswap = gr.Button(f"🖼️ >> {biniou_lang_tab_faceswap} target")
                            ...
                            with gr.Column():
                                with gr.Box():
                                    with gr.Group():
                                        ...
                                        img2var_faceswap = gr.Button(f"🖼️ >> {biniou_lang_tab_faceswap} target")
                            ...
                            with gr.Column():
                                with gr.Box():
                                    with gr.Group():
                                        ...
                                        pix2pix_faceswap = gr.Button(f"🖼️ >> {biniou_lang_tab_faceswap} target")
                            ...
                            with gr.Column():
                                with gr.Box():
                                    with gr.Group():
                                        ...
                                        magicmix_faceswap = gr.Button(f"🖼️ >> {biniou_lang_tab_faceswap} target")
                            ...
                            with gr.Column():
                                with gr.Box():
                                    with gr.Group():
                                        ...
                                        inpaint_faceswap = gr.Button(f"🖼️ >> {biniou_lang_tab_faceswap} target")
                            ...
                            with gr.Column():
                                with gr.Box():                                
                                    with gr.Group():
                                        ...
                                        paintbyex_faceswap = gr.Button(f"🖼️ >> {biniou_lang_tab_faceswap} target")
                            ...
                            with gr.Column():
                                with gr.Box():                                
                                    with gr.Group():
                                        ...
                                        outpaint_faceswap = gr.Button(f"🖼️ >> {biniou_lang_tab_faceswap} target")
                            ...
                            with gr.Column():
                                with gr.Box():
                                    with gr.Group():
                                        ...
                                        controlnet_faceswap = gr.Button(f"🖼️ >> {biniou_lang_tab_faceswap} target")
                            ...
                            with gr.Column():
                                with gr.Box():                                
                                    with gr.Group():
                                        ...
                                        faceid_ip_faceswap = gr.Button(f"🖼️ >> {biniou_lang_tab_faceswap} target")
                            ...
                            with gr.Column():
                                with gr.Box():
                                    with gr.Group():
                                        ...
                                        faceswap_faceswap = gr.Button(f"🖼️ >> {biniou_lang_tab_faceswap} target")
                            ...
                            with gr.Column():
                                with gr.Box():
                                    with gr.Group():
                                        ...
                                        resrgan_faceswap = gr.Button(f"🖼️ >> {biniou_lang_tab_faceswap} target")
                            ...
                            with gr.Column():
                                with gr.Box():
                                    with gr.Group():
                                        ...
                                        gfpgan_faceswap = gr.Button(f"🖼️ >> {biniou_lang_tab_faceswap} target")
