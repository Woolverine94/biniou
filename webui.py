...
def change_model_type_txt2img_sd(model_txt2img_sd):
    ...
    elif (model_txt2img_sd == "RunDiffusion/Juggernaut-XI-Lightning"):
        return sampler_txt2img_sd.update(value="DPM++ SDE Karras"), width_txt2img_sd.update(value=biniou_global_sdxl_width), height_txt2img_sd.update(value=biniou_global_sdxl_height), num_inference_step_txt2img_sd.update(value=6), guidance_scale_txt2img_sd.update(value=1.75), lora_model_txt2img_sd.update(choices=list(lora_model_list(model_txt2img_sd).keys()), value="", interactive=True), txtinv_txt2img_sd.update(choices=list(txtinv_list(model_txt2img_sd).keys()), value="", interactive=True), negative_prompt_txt2img_sd.update(interactive=True)
    elif ("LIGHTNING" in model_txt2img_sd.upper()) and not ("FLUX" in model_txt2img_sd.upper()):
    ...
    elif (model_txt2img_sd == "AlekseyCalvin/FluxKrea_HSTurbo_Diffusers") or (model_txt2img_sd == "buildborderless/FLUX.MF-8step_lightning_v2"):
    ...
    elif (model_txt2img_sd == "aifeifei798/DarkIdol-flux-v1.2"):
        return sampler_txt2img_sd.update(value="Flow Match Euler"), width_txt2img_sd.update(value=biniou_global_sdxl_width), height_txt2img_sd.update(value=biniou_global_sdxl_height), num_inference_step_txt2img_sd.update(value=8), guidance_scale_txt2img_sd.update(value=0.0), lora_model_txt2img_sd.update(choices=list(lora_model_list(model_txt2img_sd).keys()), value="", interactive=True), txtinv_txt2img_sd.update(choices=list(txtinv_list(model_txt2img_sd).keys()), value="", interactive=False), negative_prompt_txt2img_sd.update(interactive=False)
...
def change_lora_model_txt2img_sd(model, lora_model, prompt, steps, cfg_scale, sampler):
    ...
    if is_fast_lora(lora_model):
        ...
        elif (lora_model == "Lingyuzhou/Hyper_Flux.1_Dev_4_step_Lora") or (lora_model == "DarkMoonDragon/TurboRender-flux-dev"):
...
def change_model_type_img2img(model_img2img):
    ...
    elif (model_img2img == "RunDiffusion/Juggernaut-XI-Lightning"):
        return sampler_img2img.update(value="DPM++ SDE Karras"), width_img2img.update(), height_img2img.update(), num_inference_step_img2img.update(value=6), guidance_scale_img2img.update(value=1.75), lora_model_img2img.update(choices=list(lora_model_list(model_img2img).keys()), value="", interactive=True), txtinv_img2img.update(choices=list(txtinv_list(model_img2img).keys()), value="", interactive=True), negative_prompt_img2img.update(interactive=True)
    elif ("LIGHTNING" in model_img2img.upper()) and not ("FLUX" in model_img2img.upper()):
    ...
    elif (model_img2img == "AlekseyCalvin/FluxKrea_HSTurbo_Diffusers") or (model_img2img == "buildborderless/FLUX.MF-8step_lightning_v2"):
    ...
    elif (model_img2img == "aifeifei798/DarkIdol-flux-v1.2"):
        return sampler_img2img.update(value="Flow Match Euler"), width_img2img.update(), height_img2img.update(), num_inference_step_img2img.update(value=8), guidance_scale_img2img.update(value=0.0), lora_model_img2img.update(choices=list(lora_model_list(model_img2img).keys()), value="", interactive=True), txtinv_img2img.update(choices=list(txtinv_list(model_img2img).keys()), value="", interactive=False), negative_prompt_img2img.update(interactive=False)
...
#        return sampler_img2img_ip.update(value="UniPC"), width_img2img_ip.update(value=biniou_global_sd15_width), height_img2img_ip.update(value=biniou_global_sd15_height), num_inference_step_img2img_ip.update(value=2), guidance_scale_img2img_ip.update(value=0.0), lora_model_img2img_ip.update(choices=list(lora_model_list(model_img2img_ip).keys()), value="", interactive=True), txtinv_img2img_ip.update(choices=list(txtinv_list(model_img2img_ip).keys()), value=""), negative_prompt_img2img_ip.update(interactive=False), img_img2img_ip.update(visible=True)
    ...
    elif (model_img2img_ip == "RunDiffusion/Juggernaut-XI-Lightning"):
        return sampler_img2img_ip.update("DPM++ SDE Karras"), width_img2img_ip.update(width_value, interactive=interaction), height_img2img_ip.update(height_value, interactive=interaction), num_inference_step_img2img_ip.update(value=6), guidance_scale_img2img_ip.update(value=1.75), lora_model_img2img_ip.update(choices=list(lora_model_list(model_img2img_ip).keys()), value="", interactive=True), txtinv_img2img_ip.update(choices=list(txtinv_list(model_img2img_ip).keys()), value=""), negative_prompt_img2img_ip.update(interactive=True), source_type_img2img_ip.update(interactive=True), img_img2img_ip.update(visible=True)
    elif ("LIGHTNING" in model_img2img_ip.upper()) and not ("FLUX" in model_img2img_ip.upper()):
    ...
    elif (model_img2img_ip == "AlekseyCalvin/FluxKrea_HSTurbo_Diffusers") or (model_img2img_ip == "buildborderless/FLUX.MF-8step_lightning_v2"):
    ...
    elif (model_img2img_ip == "aifeifei798/DarkIdol-flux-v1.2"):
        return sampler_img2img_ip.update("Flow Match Euler"), width_img2img_ip.update(width_value, interactive=interaction), height_img2img_ip.update(height_value, interactive=interaction), num_inference_step_img2img_ip.update(value=8), guidance_scale_img2img_ip.update(value=0.0 if source_type == "composition" else 0.0), lora_model_img2img_ip.update(choices=list(lora_model_list(model_img2img_ip).keys()), value="", interactive=True), txtinv_img2img_ip.update(choices=list(txtinv_list(model_img2img_ip).keys()), value="", interactive=False), negative_prompt_img2img_ip.update(interactive=False), source_type_img2img_ip.update(interactive=True), img_img2img_ip.update(visible=False)
...
def change_model_type_controlnet(model_controlnet):
    ...
    elif (model_controlnet == "RunDiffusion/Juggernaut-XI-Lightning"):
        return sampler_controlnet.update(value="DPM++ SDE Karras"), width_controlnet.update(), height_controlnet.update(), num_inference_step_controlnet.update(value=6), guidance_scale_controlnet.update(value=1.75), lora_model_controlnet.update(choices=list(lora_model_list(model_controlnet).keys()), value="", interactive=True), txtinv_controlnet.update(choices=list(txtinv_list(model_controlnet).keys()), value=""), negative_prompt_controlnet.update(interactive=True), img_preview_controlnet.update(value=None), gs_img_preview_controlnet.update(value=None)
    elif ("LIGHTNING" in model_controlnet.upper()) and not ("FLUX" in model_controlnet.upper()):
    ...
    elif (model_controlnet == "AlekseyCalvin/FluxKrea_HSTurbo_Diffusers") or (model_controlnet == "buildborderless/FLUX.MF-8step_lightning_v2"):
    ...
    elif (model_controlnet == "aifeifei798/DarkIdol-flux-v1.2"):
        return sampler_controlnet.update(value="Flow Match Euler"), width_controlnet.update(), height_controlnet.update(), num_inference_step_controlnet.update(value=8), guidance_scale_controlnet.update(value=0.0), lora_model_controlnet.update(choices=list(lora_model_list(model_controlnet).keys()), value="", interactive=True), txtinv_controlnet.update(choices=list(txtinv_list(model_controlnet).keys()), value=""), negative_prompt_controlnet.update(interactive=False), img_preview_controlnet.update(value=None), gs_img_preview_controlnet.update(value=None)
...
#        return sampler_faceid_ip.update(value="UniPC"), width_faceid_ip.update(), height_faceid_ip.update(), num_inference_step_faceid_ip.update(value=2), guidance_scale_faceid_ip.update(value=0.0), lora_model_faceid_ip.update(choices=list(lora_model_list(model_faceid_ip).keys()), value="", interactive=True), txtinv_faceid_ip.update(choices=list(txtinv_list(model_faceid_ip).keys()), value=""), negative_prompt_faceid_ip.update(interactive=False), prompt_faceid_ip.update()
    ...
    elif (model_faceid_ip == "RunDiffusion/Juggernaut-XI-Lightning"):
        if not ((" img " in prompt) or (" img," in prompt) or (" img:" in prompt)):
            photomaker_prompt_faceid_ip = " img "+ prompt
        else:
            photomaker_prompt_faceid_ip = prompt
        return sampler_faceid_ip.update(value="DPM++ SDE Karras"), width_faceid_ip.update(value=biniou_global_sdxl_width), height_faceid_ip.update(value=biniou_global_sdxl_height), num_inference_step_faceid_ip.update(value=8), guidance_scale_faceid_ip.update(value=1.75), lora_model_faceid_ip.update(choices=list(lora_model_list(model_faceid_ip).keys()), value="", interactive=True), txtinv_faceid_ip.update(choices=list(txtinv_list(model_faceid_ip).keys()), value=""), negative_prompt_faceid_ip.update(interactive=True), prompt_faceid_ip.update(value=photomaker_prompt_faceid_ip)
...
def change_model_type_txt2vid_ze(model_txt2vid_ze):
    ...
    elif (model_txt2vid_ze == "RunDiffusion/Juggernaut-XI-Lightning"):
        return sampler_txt2vid_ze.update(value="DPM++ SDE Karras"), width_txt2vid_ze.update(value=biniou_global_sdxl_width), height_txt2vid_ze.update(value=biniou_global_sdxl_height), num_inference_step_txt2vid_ze.update(value=6), guidance_scale_txt2vid_ze.update(value=1.75), negative_prompt_txt2vid_ze.update(interactive=True)
