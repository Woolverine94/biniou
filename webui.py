...
def change_model_type_txt2img_sd(model_txt2img_sd):
    ...
    elif (model_txt2img_sd == "segmind/SSD-1B") or (model_txt2img_sd == "stabilityai/stable-diffusion-xl-base-1.0") or (model_txt2img_sd == "dataautogpt3/OpenDalleV1.1") or (('xl' or 'XL' or 'Xl' or 'xL') in model_txt2img_sd):
...
def change_model_type_img2img(model_img2img):
    ...
    elif (model_img2img == "segmind/SSD-1B") or (model_img2img == "stabilityai/stable-diffusion-xl-refiner-1.0") or (model_img2img == "dataautogpt3/OpenDalleV1.1") or (('xl' or 'XL' or 'Xl' or 'xL') in model_img2img):
...
#        return sampler_img2img_ip.update(value="UniPC"), width_img2img_ip.update(value=512), height_img2img_ip.update(value=512), num_inference_step_img2img_ip.update(value=2), guidance_scale_img2img_ip.update(value=0.0), lora_model_img2img_ip.update(choices=list(lora_model_list(model_img2img_ip).keys()), value="", interactive=True), negative_prompt_img2img_ip.update(interactive=False)
    ...
    elif (model_img2img_ip == "segmind/SSD-1B") or (model_img2img_ip == "stabilityai/stable-diffusion-xl-refiner-1.0") or (model_img2img_ip == "dataautogpt3/OpenDalleV1.1") or (('xl' or 'XL' or 'Xl' or 'xL') in model_img2img_ip):
        return sampler_img2img_ip.update(value=list(SCHEDULER_MAPPING.keys())[0]), width_img2img_ip.update(value=1024), height_img2img_ip.update(value=1024), num_inference_step_img2img_ip.update(value=10), guidance_scale_img2img_ip.update(value=7.5), lora_model_img2img_ip.update(choices=list(lora_model_list(model_img2img_ip).keys()), value="", interactive=True), negative_prompt_img2img_ip.update(interactive=True)
...
def change_model_type_controlnet(model_controlnet):
    ...
    elif (model_controlnet == "segmind/SSD-1B") or (model_controlnet == "stabilityai/stable-diffusion-xl-base-1.0") or (model_controlnet == "dataautogpt3/OpenDalleV1.1")  or (('xl' or 'XL' or 'Xl' or 'xL') in model_controlnet):
...
#        return sampler_faceid_ip.update(value="UniPC"), width_faceid_ip.update(), height_faceid_ip.update(), num_inference_step_faceid_ip.update(value=2), guidance_scale_faceid_ip.update(value=0.0), lora_model_faceid_ip.update(choices=list(lora_model_list(model_faceid_ip).keys()), value="", interactive=True), negative_prompt_faceid_ip.update(interactive=False)
    ...
    elif (model_faceid_ip == "segmind/SSD-1B") or (model_faceid_ip == "stabilityai/stable-diffusion-xl-refiner-1.0") or (model_faceid_ip == "dataautogpt3/OpenDalleV1.1") or (('xl' or 'XL' or 'Xl' or 'xL') in model_faceid_ip):
...
def change_model_type_txt2vid_ze(model_txt2vid_ze):
    ...
    elif (model_txt2vid_ze == "segmind/SSD-1B") or (model_txt2vid_ze == "dataautogpt3/OpenDalleV1.1") or (('xl' or 'XL' or 'Xl' or 'xL') in model_txt2vid_ze):
