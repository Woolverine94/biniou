...
def change_model_type_txt2img_sd(model_txt2img_sd):
    ...
    elif (model_txt2img_sd == "sd-community/sdxl-flash"):
        return sampler_txt2img_sd.update(value="DPM++ SDE"), width_txt2img_sd.update(value=biniou_global_sdxl_width), height_txt2img_sd.update(value=biniou_global_sdxl_height), num_inference_step_txt2img_sd.update(value=6), guidance_scale_txt2img_sd.update(value=3.0), lora_model_txt2img_sd.update(choices=list(lora_model_list(model_txt2img_sd).keys()), value="", interactive=True), txtinv_txt2img_sd.update(choices=list(txtinv_list(model_txt2img_sd).keys()), value=""), negative_prompt_txt2img_sd.update(interactive=True)
    elif (model_txt2img_sd == "RunDiffusion/Juggernaut-X-Hyper"):
        return sampler_txt2img_sd.update(value="DPM++ SDE Karras"), width_txt2img_sd.update(value=biniou_global_sdxl_width), height_txt2img_sd.update(value=biniou_global_sdxl_height), num_inference_step_txt2img_sd.update(value=6), guidance_scale_txt2img_sd.update(value=1.0), lora_model_txt2img_sd.update(choices=list(lora_model_list(model_txt2img_sd).keys()), value="", interactive=True), txtinv_txt2img_sd.update(choices=list(txtinv_list(model_txt2img_sd).keys()), value=""), negative_prompt_txt2img_sd.update(interactive=True)
    elif ("XL" in model_txt2img_sd.upper()) or (model_txt2img_sd == "dataautogpt3/OpenDalleV1.1") or (model_txt2img_sd == "dataautogpt3/ProteusV0.4") or (model_txt2img_sd == "aipicasso/emi-2"):
...
def change_model_type_img2img(model_img2img):
    if (model_img2img == "stabilityai/sdxl-turbo"):
        ...
        return sampler_img2img.update(value="DPM++ SDE Karras"), width_img2img.update(), height_img2img.update(), num_inference_step_img2img.update(value=4), guidance_scale_img2img.update(value=1.0), lora_model_img2img.update(choices=list(lora_model_list(model_img2img).keys()), value="", interactive=True), txtinv_img2img.update(choices=list(txtinv_list(model_img2img).keys()), value=""), negative_prompt_img2img.update(interactive=True)
    elif (model_img2img == "sd-community/sdxl-flash"):
        return sampler_img2img.update(value="DPM++ SDE"), width_img2img.update(), height_img2img.update(), num_inference_step_img2img.update(value=6), guidance_scale_img2img.update(value=3.0), lora_model_img2img.update(choices=list(lora_model_list(model_img2img).keys()), value="", interactive=True), txtinv_img2img.update(choices=list(txtinv_list(model_img2img).keys()), value=""), negative_prompt_img2img.update(interactive=True)
    elif (model_img2img == "RunDiffusion/Juggernaut-X-Hyper"):
        return sampler_img2img.update(value="DPM++ SDE Karras"), width_img2img.update(), height_img2img.update(), num_inference_step_img2img.update(value=6), guidance_scale_img2img.update(value=1.0), lora_model_img2img.update(choices=list(lora_model_list(model_img2img).keys()), value="", interactive=True), txtinv_img2img.update(choices=list(txtinv_list(model_img2img).keys()), value=""), negative_prompt_img2img.update(interactive=True)
    elif ("XL" in model_img2img.upper()) or (model_img2img == "dataautogpt3/OpenDalleV1.1")  or (model_img2img == "dataautogpt3/ProteusV0.4") or (model_img2img == "aipicasso/emi-2"):
        ...
        return sampler_img2img.update(value=list(SCHEDULER_MAPPING.keys())[0]), width_img2img.update(), height_img2img.update(), num_inference_step_img2img.update(value=10), guidance_scale_img2img.update(value=3.0), lora_model_img2img.update(choices=list(lora_model_list(model_img2img).keys()), value="", interactive=False), txtinv_img2img.update(choices=list(txtinv_list(model_img2img).keys()), value=""), negative_prompt_img2img.update(interactive=True)
    elif (model_img2img == "playgroundai/playground-v2.5-1024px-aesthetic"):
        return sampler_img2img.update(value="EDM DPM++ 2M"), width_img2img.update(), height_img2img.update(), num_inference_step_img2img.update(value=15), guidance_scale_img2img.update(value=3.0), lora_model_img2img.update(choices=list(lora_model_list(model_img2img).keys()), value="", interactive=False), txtinv_img2img.update(choices=list(txtinv_list(model_img2img).keys()), value=""), negative_prompt_img2img.update(interactive=True)
...
#        return sampler_img2img_ip.update(value="UniPC"), width_img2img_ip.update(value=biniou_global_sd15_width), height_img2img_ip.update(value=biniou_global_sd15_height), num_inference_step_img2img_ip.update(value=2), guidance_scale_img2img_ip.update(value=0.0), lora_model_img2img_ip.update(choices=list(lora_model_list(model_img2img_ip).keys()), value="", interactive=True), txtinv_img2img_ip.update(choices=list(txtinv_list(model_img2img_ip).keys()), value=""), negative_prompt_img2img_ip.update(interactive=False)
    ...
    elif (model_img2img_ip == "sd-community/sdxl-flash"):
    ...
    elif ("XL" in model_img2img_ip.upper()) or (model_img2img_ip == "dataautogpt3/OpenDalleV1.1") or (model_img2img_ip == "dataautogpt3/ProteusV0.4") or (model_img2img_ip == "aipicasso/emi-2"):
...
def change_model_type_controlnet(model_controlnet):
    ...
    elif (model_controlnet == "sd-community/sdxl-flash"):
    ...
    elif ("XL" in model_controlnet.upper()) or (model_controlnet == "dataautogpt3/OpenDalleV1.1") or (model_controlnet == "dataautogpt3/ProteusV0.4") or (model_controlnet == "aipicasso/emi-2"):
...
#        return sampler_faceid_ip.update(value="UniPC"), width_faceid_ip.update(), height_faceid_ip.update(), num_inference_step_faceid_ip.update(value=2), guidance_scale_faceid_ip.update(value=0.0), lora_model_faceid_ip.update(choices=list(lora_model_list(model_faceid_ip).keys()), value="", interactive=True), txtinv_faceid_ip.update(choices=list(txtinv_list(model_faceid_ip).keys()), value=""), negative_prompt_faceid_ip.update(interactive=False), prompt_faceid_ip.update()
    ...
    elif (model_faceid_ip  == "sd-community/sdxl-flash"):
        if not ((" img " in prompt) or (" img," in prompt) or (" img:" in prompt)):
            photomaker_prompt_faceid_ip = " img "+ prompt
        else:
            photomaker_prompt_faceid_ip = prompt
        ...
        if not ((" img " in prompt) or (" img," in prompt) or (" img:" in prompt)):
            ...
            photomaker_prompt_faceid_ip = prompt
        return sampler_faceid_ip.update(value="DPM++ SDE Karras"), width_faceid_ip.update(value=biniou_global_sdxl_width), height_faceid_ip.update(value=biniou_global_sdxl_height), num_inference_step_faceid_ip.update(value=6), guidance_scale_faceid_ip.update(value=1.0), lora_model_faceid_ip.update(choices=list(lora_model_list(model_faceid_ip).keys()), value="", interactive=True), txtinv_faceid_ip.update(choices=list(txtinv_list(model_faceid_ip).keys()), value=""), negative_prompt_faceid_ip.update(interactive=True), prompt_faceid_ip.update(value=photomaker_prompt_faceid_ip)
    elif ("XL" in model_faceid_ip.upper()) or (model_faceid_ip == "dataautogpt3/OpenDalleV1.1") or (model_faceid_ip == "dataautogpt3/ProteusV0.4") or (model_faceid_ip == "aipicasso/emi-2"):
        if not ((" img " in prompt) or (" img," in prompt) or (" img:" in prompt)):
            photomaker_prompt_faceid_ip = " img "+ prompt
        else:
            photomaker_prompt_faceid_ip = prompt
...
def change_model_type_txt2vid_ze(model_txt2vid_ze):
    ...
    elif (model_txt2vid_ze == "sd-community/sdxl-flash"):
    ...
    elif ("XL" in model_txt2vid_ze.upper()) or ("ETRI-VILAB/KOALA-" in model_txt2vid_ze.upper()) or (model_txt2vid_ze == "segmind/SSD-1B") or (model_txt2vid_ze == "dataautogpt3/OpenDalleV1.1") or (model_txt2vid_ze == "dataautogpt3/ProteusV0.4") or (model_txt2vid_ze == "aipicasso/emi-2"):
