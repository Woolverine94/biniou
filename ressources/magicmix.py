...
model_list_magicmix = model_list_magicmix_builtin

for k in range(len(model_list_magicmix_local)):
    model_list_magicmix.append(model_list_magicmix_local[k])
