...
(model == "dataautogpt3/ProteusSigma") or \
(model == "Ricardouchub/SarcasmDiffusion")\
):
        is_sdxl_value = True
    else:
        is_sdxl_value = False
...
def model_cleaner_lora(model):
    model_replacement = {
        ...
        "-[ 🏆 🐢 🖼️ Artistic Flux LoRA ]-": "Datou1111/Yoji_Shinkawa",
        "-[ 🏆 🐢 📷 Photographic Flux LoRA ]-": "alvdansen/flux-koda",
        "-[ 👌 🎨 Style SDXL LoRA ]-": "goofyai/3d_render_style_xl",
        "-[ 🏆 🐢 🎨 Style Flux LoRA ]-": "Jovie/Midjourney",
...
#            "ByteDance/Hyper-SD":("Hyper-SDXL-1step-lora.safetensors", ""),
        ...
        model_list_lora_builtin = {
            ...
            "sheko007/realistic-skin":("skin_4-000015.safetensors", "Detailed natural skin and blemishes without-makeup and acne"),
            "HyperX-Sentience/UltraResXL":("UltraResXL.safetensors", "Ultra-realism"),
            ...
            "ntc-ai/SDXL-LoRA-slider.glowing-eyes":("glowing eyes.safetensors", "glowing eyes"),
            "Muapi/lora-eyes-enhancer-free-use-or-merge":("lora-eyes-enhancer-free-use-or-merge.safetensors", ""),
            ...
            "alvdansen/littletinies":("Little_Tinies.safetensors", ""),
            "blink7630/storyboard-sketch":("Storyboard_sketch.safetensors", "storyboard sketch of"),
            ...
            "blink7630/graphic-novel-illustration":("Graphic_Novel_Illustration-000007.safetensors", "graphic novel illustration"),
...
#            "-[ 🏆 🐢 Flux LoRA ]-":("pola_photo_araminta_k.safetensors", "polaroid style"),
            ...
            "ampp/Chromatic_Grit":("AMPP_Chromatic_GritV3.safetensors", "Chromatic Grit"),
            "prithivMLmods/Street-Bokeh-Flux-LoRA":("Street_Bokeh.safetensors", "Street Bokeh"),
            "prithivMLmods/Flux.1-Dev-LoRA-HDR-Realism":("HDR.safetensors", "HDR"),
            ...
            "gokaygokay/Flux-Watercolor-Strokes-LoRA":("watercolor_strokes.safetensors", "WTRCLR, watercolor"),
            "ANGJustinl/flux_Art_Design_Style_Lora":("flux-Design-lora24G.safetensors", ""),
            "SebastianBodza/Flux_Aquarell_Watercolor_v2":("lora.safetensors", "AQUACOLTOK"),
            "renderartist/ROYGBIVFlux":("ROYGBIV_Flux_v2_renderartist.safetensors", "r0ygb1v, digital illustration, textured"),
            "dvyio/flux-lora-stippled-illustration":("31984be602a04a1fa296d9ccb244fb29_pytorch_lora_weights.safetensors", "stippled illustration in the style of STPPLD"),
            "treeshark/interiorzpaint-v7.safetensors":("interiorzpaint-v7.safetensors", ""),
            ...
            "Wadaka/Mojo_Style_LoRA":("Mojo_Style_LoRA.safetensors", "Mojo_Style"),
            "DIOcheng/flux-lora-Cartoonillustration":("Cartoon illustration_flux_lora_v1.safetensors", ""),
            "dvyio/flux-lora-victorian-drawing":("33909d002c774014a296e71986042065_pytorch_lora_weights.safetensors", "illustration in the style of VCTRNDRWNG"),
            ...
            "furaidosu/flux-cubist-cartoon":("lora.safetensors", "CBSTCRTN"),
            "furaidosu/flux-lora-piccoli-figurative-full-captions":("lora.safetensors", "PCCLFGRTV"),
...
#            "kudzueye/Boreal":("boreal-flux-dev-lora-v04_1000_steps.safetensors", "photo"),
            ...
            "glif-loradex-trainer/fab1an_polaroid":("polaroid.safetensors", "polaroid"),
            "AlekseyCalvin/HSToric_Focus_Flux_Lora":("HST_Color_Flux_smallDataset.safetensors", "HST style analog film photo"),
            "alvdansen/flux_film_foto":("araminta_k_flux_film_foto.safetensors", "flmft photo style"),
            ...
            "Muapi/ultrarealistic-lora-project":("ultrarealistic-lora-project.safetensors", "amateurish photo, low lighting, in motion, overexposed, underexposed, GoPro lens, eerie atmosphere, smeared background, smeared foreground"),
            ...
            "cocktailpeanut/doom":("doom.safetensors", "doom"),
            "prithivMLmods/Castor-3D-Portrait-Flux-LoRA":("Castor-3D-Portrait-Flux-LoRA.safetensors", "3D Portrait"),
            "treeshark/KomikZv10.safetensors":("KomikZv10.safetensors", "A comic book drawing in pen and ink"),
            "glif-loradex-trainer/saq1b_halftone":("halftone.safetensors", "halftone style"),
            "fofr/flux-wrong":("lora.safetensors", "WRNG"),
            "treeshark/mechanimalz-v2.safetensors":("mechanimalz-v2.safetensors", ""),
            ...
            "davisbro/photo-glow":("lora.safetensors", "TOK"),
            ...
            "fofr/flux-bad-70s-food":("lora.safetensors", "bad 70s food"),
            "fofr/flux-minecraft-movie":("lora.safetensors", "MNCRFTMOV"),
            ...
            "glif-loradex-trainer/kklors_flux_dev_Lightning":("flux_dev_Lightning.safetensors", "LIGHTNING"),
            "Muapi/dungeons-and-dragons-covers-dnd-5e":("dungeons-and-dragons-covers-dnd-5e.safetensors", "cover of a dnd 5e book"),
            "busetolunay/building_flux_lora_v1":("building_flux_lora_v4.safetensors", "a0ce"),
            "PPSharks/cyber-rune-logo-flux":("cyber-rune-logo-flux.safetensors", ""),
            "furaidosu/flux-lora-total-drama-character":("lora.safetensors", "TTLDRMCHR"),
            ...
            "Wakkamaruh/balatro-poker-cards":("balatro-poker-cards.safetensors", "balatrocard, a pixel art of"),
