...
model_list_llava_builtin = {
    ...
    "cjpais/llava-v1.6-34B-gguf":("llava-v1.6-34b.Q5_K_M.gguf", "mmproj-model-f16.gguf", "<|im_start|>system\n{system_prompt}<|im_end|>\n<|im_start|>user\n{prompt}<|im_end|>\n<|im_start|>assistant", "You are a very helpful assistant. You are accurate, concise, reliable and you never refuse to answer."),
    ...
    "cinnabrad/llama-joycaption-beta-one-hf-llava-mmproj-gguf":("Llama-Joycaption-Beta-One-Hf-Llava-Q4_K_M.gguf", "llama-joycaption-beta-one-llava-mmproj-model-f16.gguf", "{prompt}", ""),
