...
def image_resrgan(
    ...
    huggingface_hub.cached_download = lambda *args, **kwargs: hf_hub_download(
		"schwgHao/RealESRGAN_x4plus" if modelid_resrgan == "RealESRGAN_x4plus.pth" else "sberbank-ai/Real-ESRGAN",
		modelid_resrgan,
		local_dir=model_path_resrgan,
		**kwargs
    )
    ...
    hf_hub_download("schwgHao/RealESRGAN_x4plus", "RealESRGAN_x4plus.pth", local_dir=model_path_resrgan)
